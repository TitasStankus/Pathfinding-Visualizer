...
namespace Pathfinding_Visualizer.Algorithms
{
    public class DepthFirstSearch
    {
        ...
        public DepthFirstSearch(GridModel gridModel, Helpers helpers, AnimationController animationController, Stopwatch stopwatch, StatisticsManager statisticsManager)
        {
